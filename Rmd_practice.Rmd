...
### 7. Now let's consider the possible association between economic freedom ($X$) and GDP per capita ($Y$). Plot two scatterplots: one of all the data points, and one by continent. 
...
### 9. Europe seems to have the greatest variation. 
